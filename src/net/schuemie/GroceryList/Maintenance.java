...
public class Maintenance extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        itemsCursor = managedQuery(GroceryListContentProvider.ITEMS_URI, null, null, null, null);	
		...
		getContentResolver().registerContentObserver(GroceryListContentProvider.ITEMS_URI, true, itemsContentObserver);
		getContentResolver().registerContentObserver(GroceryListContentProvider.CATEGORIES_URI, true, categoriesContentObserver);
	...
	public void handleEditCategoriesClick(){
		Intent intent = new Intent(Intent.ACTION_EDIT, GroceryListContentProvider.CATEGORIES_URI);
    ...
    private void confirmDeleteAll(){
        ...
        .setPositiveButton(R.string.ok_label, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int whichButton) {
            	getContentResolver().delete(GroceryListContentProvider.ITEMS_URI, null, null);
            	getContentResolver().delete(GroceryListContentProvider.CATEGORIES_URI, null, null);
            }
