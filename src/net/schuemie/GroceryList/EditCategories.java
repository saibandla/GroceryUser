...
public class EditCategories  extends ListActivity {
	...
	private void handleCreateClick(){
		Intent intent = new Intent(Intent.ACTION_INSERT, GroceryListContentProvider.CATEGORIES_URI);
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case ITEM_DELETE: 
                ...
                return true;
            case ITEM_EDIT: 
            	Uri categoryUri = ContentUris.withAppendedId(GroceryListContentProvider.CATEGORIES_URI, info.id);
    ...
    private void confirmDeleteCategory(){
        ...
        .setPositiveButton(R.string.ok_label, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int whichButton) {
            	Uri categoryUri = ContentUris.withAppendedId(GroceryListContentProvider.CATEGORIES_URI, deleteID);
