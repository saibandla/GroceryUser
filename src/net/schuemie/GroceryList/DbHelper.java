...
public class DbHelper extends SQLiteOpenHelper {
	...
	private static final String SAKET_TABLE_CREATE = "CREATE TABLE IF NOT EXISTS  "
			...
			+ "username TEXT NOT NULL, password TEXT NOT NULL, email TEXT NOT NULL, address TEXT NOT NULL);";
	...
	public String isPasswordExists(String passwrd)
	{
		...
		Cursor cursor=db.query(SAKET_TABLE_NAME, null, " password=?", new String[]{passwrd}, null, null, null);
